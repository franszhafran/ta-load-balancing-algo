 ...
 */
public class DatacenterBrokerTA extends SimEntity {
	...
	/**
	 * Created a new DatacenterBrokerTA object.
	 * 
	 ...
	 * @post $none
	 */
	public DatacenterBrokerTA(String name) throws Exception {
		super(name);
	...
	protected void processOtherEvent(SimEvent ev) {
		...
		Log.printConcatLine(getName(), ".processOtherEvent(): Error - event unknown by this DatacenterBrokerTA.");
	}
