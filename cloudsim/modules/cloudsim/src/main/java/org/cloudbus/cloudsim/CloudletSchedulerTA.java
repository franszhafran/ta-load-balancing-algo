...
/**
 * CloudletSchedulerTA implements a policy of scheduling performed by a virtual machine
 ...
 */
public class CloudletSchedulerTA extends CloudletScheduler {
	...
	/**
	 * Creates a new CloudletSchedulerTA object. This method must be invoked before starting
	 * the actual simulation.
	 * 
	 * @pre $none
	 * @post $none
	 */
	public CloudletSchedulerTA() {
		super();
		currentCPUs = 0;
	}
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		for (ResCloudlet rcl : getCloudletExecList()) {
			...
			if (estimatedFinishTime < nextEvent && rcl.getCloudlet().getCloudletId() != rcl.getCloudlet().getVmId()) {
